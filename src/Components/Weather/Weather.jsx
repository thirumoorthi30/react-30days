...
export default function Weather() {
  ...
  const { data: weather, error, isLoading } = useSWR(
    city ? `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${API_KEY}&units=metric` : null,
    fetcher
  );
  ...
  return (
    <Layout>
      <div className={`min-h-[93.5vh] flex items-center justify-center p-4 ${
        ...
        <div className={`shadow-lg rounded-xl p-6 w-full max-w-md ${
          ...
          {weather && (
            <div className="text-center space-y-3">
              ...
              <h1 className="text-5xl font-bold text-blue-600">{weather.main.temp}°C</h1>
